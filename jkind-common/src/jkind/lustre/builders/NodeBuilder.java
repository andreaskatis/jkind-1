...
public class NodeBuilder {
	...
	private List<String> realizabilities = new ArrayList<>();
	...
	public NodeBuilder(Node node) {
		...
		this.realizabilities = new ArrayList<>(node.realizabilities);
	}
	...
	public NodeBuilder addRealizability(String realizability) {
		this.realizabilities.add(realizability);
		return this;
	}

	public NodeBuilder addRealizabilities(Collection<String> realizabilities) {
		this.realizabilities.addAll(realizabilities);
		return this;
	}

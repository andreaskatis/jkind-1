...
public class JRealizabilityArgumentParser {
	...
	public static JRealizabilitySettings parse(String[] args) {
		...
		try {
			JRealizabilitySettings settings = getSettings(parser.parse(getOptions(), args));
	...
	private static JRealizabilitySettings getSettings(CommandLine line) {
		JRealizabilitySettings settings = new JRealizabilitySettings();
